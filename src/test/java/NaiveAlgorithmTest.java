...
public class NaiveAlgorithmTest {
    ...
    private void testTrue(LabelledTransitionSystem M) {
        ArrayList<String> eval = NaiveAlgorithm.eval(new MuCalculusFormula("true"), M);
    ...
    private void testFalse(LabelledTransitionSystem M) {
        ArrayList<String> eval = NaiveAlgorithm.eval(new MuCalculusFormula("false"), M);
    ...
    private void testEvaluation(LabelledTransitionSystem M, MuCalculusFormula f, Collection<String> expected) {
        ArrayList<String> eval = NaiveAlgorithm.eval(f, M);
